    ...
    return (
        <>
            <div className="w-1/4 h-full bg-black text-white flex flex-col gap-2 p-4">
                ...
                <div className="w-36 h-12 text-xl font-semibold cursor-pointer flex items-center gap-3 pl-4 hover:bg-gray-800 rounded-md transition-all duration-200">
                    <FaSearch className="text-white" />
                    <div>Explore</div>
                </div>
                <div className="w-56 h-12 text-xl font-semibold cursor-pointer flex items-center gap-3 pl-4 hover:bg-gray-800 rounded-md transition-all duration-200">
                    <FaBell className="text-white" />
                    <div>Notifications</div>
                </div>
                <div className="w-48 h-12 text-xl font-semibold cursor-pointer flex items-center gap-3 pl-4 hover:bg-gray-800 rounded-md transition-all duration-200">
